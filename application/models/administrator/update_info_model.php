...
class Update_info_model extends CI_Model{
	...
	*/
	...
	public function get_order_details_unreleased($order_id, $lfsi_id/*, $product_code*/){
	...
	public function get_order_details_released($order_id, $lfsi_id){
		...
		$query = $this->db->query("SELECT o.order_id, o.order_date, o.order_total, d.fname, d.lname, o.release_date FROM `order` o, `distributor` d where o.order_id = '$order_id' AND d.lfsi_id = '$lfsi_id'");
