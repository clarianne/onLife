...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <title>onLife :: HOME</title>


    <link href="<?php echo base_url(); ?>assets/css/bootstrap.css" rel="stylesheet">

    <link href="<?php echo base_url(); ?>assets/css/carousel.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/css/modulestyle.css" rel="stylesheet">
  ...
  <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php echo base_url(); ?>assets/img/mini_logo.png" height="50px"></a>
        </div>
    ...
    { //email verification
      ...
      $.ajax({
		...
		beforeSend: function (){
			...
			$("#err").html("<img src='<?php echo base_url();?>assets/img/ajax-loader.gif' />");
		},		
