                                    ...
                                    foreach ($sql2 as $q){
                                        echo "<tr id = '{$q->order_id}'>";
                                            ...
                                            echo "<td>";
                                                ...
                                                echo "<button type='submit' class='updateButton btn btn-default' name='update'><a data-toggle='tooltip' class='tooltipLink' data-original-title='Download as PDF'><i class ='fa fa-download'></i></a></button></form>";
                                                echo "</td></tr>";
                                            }
                                        echo "</tbody>";
                                    }
