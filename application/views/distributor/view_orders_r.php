            ...
            <div class="col-lg-9">
                <div id="main-page">
                    ...
                    <form name="update" id="update" class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                                <label for="prod_name" class="col-sm-2 control-label">Release Date</label>
                            <div class="col-md-8">
                                    <label for="prod_name" class="col-sm-2 control-label"><?php echo $update_details->release_date;?></label>
                                </div>
