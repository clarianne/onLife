         ...
         <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a  href="<?php echo site_url();?>/admin/home" class="navbar-brand" style = "cursor: pointer;"><img src="<?php echo base_url();?>dist/images/logo2.png" height="70px;"></a>
                </div>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"><img src="<?php echo site_url();?>/dist/images/logo2.png" height="70px"></a>
                </div>
            </div>
        </div>
<?php } ?>
