...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="col-lg-9">
				<div id="main-page">
					<div id = "main-content">
							<h2> List of all Unreleased Orders </h2>
							<ol class="breadcrumb">
								<li><a href="<?php echo base_url()?>admin/home">Home</a></li>
								<li class="active"> Unreleased Orders </li>
							</ol>
						<div class="row">
                                ...
                                if(count($flag)==0){
                                    ...
                                    foreach ($sql2 as $q){
										echo "<tr id = '{$q->order_id}'>";
											...
											echo "<td class = 'order_date'>" . $q->order_date . "</td><td>";

												echo "<form method='post' name='update' action='view_orders_unreleased'>";
												echo "<input type='hidden' name='order_id' value='" . $q->order_id . "'/>";
												echo "<input type='hidden' name='lfsi_id' value='" . $q->lfsi_id . "'/>";
												echo "<button type='submit' class='viewButton btn btn-default' name='update'><a data-toggle='tooltip' class='tooltipLink' data-original-title='View'><i class ='fa fa-info'></i></a></button></form>";
												echo "</td></tr>";
											}
                                       	echo "</tbody>";
                                    }
